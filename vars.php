<?php 
    $l_inicio = '"http://ultratech.infinityfreeapp.com//inicio.php"';
    $l_precios = '"http://ultratech.infinityfreeapp.com//precios.php"';
    $l_prfs = '"http://ultratech.infinityfreeapp.com//prfs.php"';
