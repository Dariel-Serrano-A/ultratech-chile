        ...
        <div class="container-fluid px-5 cntr-base">
            ...
            <div class="row">             
                <div class="col-xl-12 mb-3 px-2">
                    <div class="prfs-question" onclick="toggleAnswer('r1')">
                        <h3>¿Qué servicios ofrece Ultratech Chile?</h3>
                    </div>
                    <div class="prfs-answer" id="r1">
                ...
                <div class="col-xl-12 mb-3 px-2">
                    <div class="prfs-question" onclick="toggleAnswer('r2')">
                        <h3>¿En qué se diferencia el desarrollo web de Ultratech Chile?</h3>
                    </div>
                    <div class="prfs-answer" id="r2">
                ...
                <div class="col-xl-12 mb-3 px-2">
                    <div class="prfs-question" onclick="toggleAnswer('r3')">
                        <h3>¿Qué incluye el soporte técnico de computadoras?</h3>
                    </div>
                    <div class="prfs-answer" id="r3">
                ...
                <div class="col-xl-12 mb-3 px-2">
                    <div class="prfs-question" onclick="toggleAnswer('r4')">
                        <h3>¿Cómo puedo elegir el plan de hosting adecuado para mi sitio web?</h3>
                    </div>
                    <div class="prfs-answer" id="r4">
                ...
                <div class="col-xl-12 mb-3 px-2">
                    <div class="prfs-question" onclick="toggleAnswer('r5')">
                        <h3>¿Qué tipo de software licenciado instalan?</h3>
                    </div>
                    <div class="prfs-answer" id="r5">
                ...
                <div class="col-xl-12 mb-3 px-2">
                    <div class="prfs-question" onclick="toggleAnswer('r6')">
                        <h3>¿Qué estrategias de marketing digital ofrecen?</h3>
                    </div>
                    <div class="prfs-answer" id="r6">
                ...
                <div class="col-xl-12 mb-3 px-2">
                    <div class="prfs-question" onclick="toggleAnswer('r7')">
                        <h3>¿Ofrecen servicios de mantenimiento o instalación de impresoras?</h3>
                    </div>
                    <div class="prfs-answer" id="r7">
                ...
                <div class="col-xl-12 mb-3 px-2">
                <div class="prfs-question" onclick="toggleAnswer('r8')">
                        <h3>¿Cómo funciona su atención remota?</h3>
                    </div>
                    <div class="prfs-answer" id="r8">
                ...
                <div class="col-xl-12 mb-3 px-2">
                    <div class="prfs-question" onclick="toggleAnswer('r9')">
                        <h3>¿Cómo puedo contactar a Ultratech Chile para un servicio?</h3>
                    </div>
                    <div class="prfs-answer" id="r9">
