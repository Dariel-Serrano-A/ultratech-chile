    ...
    <div class="row">
        ...
        <div class="col-xl-4 justify-content-center align-items-end moviles">
            ...
            <div class="row sidenav" id="mySidenav">
                ...
                <a onclick="redirectWithBlur(event)" href="http://ultratech.infinityfreeapp.com/inicio.php"> 
                    <button type="button" class="btn btn-outline btn-lg"> Inicio </button>    
                </a>
                <a onclick="redirectWithBlur(event)" href="http://ultratech.infinityfreeapp.com/precios.php"> 
                    <button type="button" class="btn btn-outline btn-lg"> Precios </button>    
                </a>
                <a onclick="redirectWithBlur(event)" href="http://ultratech.infinityfreeapp.com/fqas.php"> 
